...
test_data_gen = BatchGen(val_reader, discretizer,
                        normalizer, args.test_batch_size,
                        False, False, shuffle=False)

if args.model_type == "LSTM":
    model = LSTM_Model(args)
if args.model_type == "SAnD":
    model = SAnD(input_features=76, seq_len=args.sequence_length, n_heads=16, factor=1, n_class=25, n_layers=2, d_model=256, dropout_rate=args.dropout_rate)
